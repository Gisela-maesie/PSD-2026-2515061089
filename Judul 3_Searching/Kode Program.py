...
def main():
    nilai_siswa = [60, 55, 100, 70, 75, 70, 80, 90, 65, 80, 95, 60, 45, 50, 40, 100, 100, 50, 65, 90]
    n = len(nilai_siswa)
    ...
    if counter > 0:
        ...
        print(f"Keterangan: Ada {counter} orang siswa"
              f" yang mendapatkan nilai {target} dalam try out ini")
    else:
